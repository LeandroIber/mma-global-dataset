...
# ALTERADO: organizacao LFA -> KSW (Konfrontacja Sztuk Walki)
ORG_URL = "https://www.sherdog.com/organizations/Konfrontacja-Sztuk-Walki-668"
...
def main():
    ...
    # ALTERADO: mensagem LFA -> KSW
    print(f"\nSucesso! {len(df)} eventos únicos do KSW salvos em: {out}")
