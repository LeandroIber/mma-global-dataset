...
# ALTERADO: organizacao KSW -> ACA (Absolute Championship Akhmat)
ORG_URL = "https://www.sherdog.com/organizations/Absolute-Championship-Akhmat-8185"
...
def main():
    ...
    # ALTERADO: mensagem KSW -> ACA
    print(f"\nSucesso! {len(df)} eventos únicos do ACA salvos em: {out}")
