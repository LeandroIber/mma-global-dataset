...
DATASET_SLUG = "cage-warriors-mma-dataset"
DATASET_TITLE = "Cage Warriors MMA Dataset Complete"
CSV_FILE = "clean_sherdog_cagewarriors.csv"
UPLOAD_DIR = "kaggle_upload"
METADATA_FILE = "dataset-metadata.json"
DATASET_DESCRIPTION = (
    "Dataset completo da Cage Warriors, raspado do "
    "Sherdog.com. Eventos, lutas, resultados, metodos, arbitros e biometria "
    "dos lutadores em sistema metrico. A coluna event_status indica o estado "
    "do evento: REALIZADO, AGENDADO (evento futuro / luta ainda nao ocorrida), "
    "CANCELADO ou ERRO_FETCH (falha na coleta)."
)
