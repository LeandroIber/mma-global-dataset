...
OUTPUT_FILE = "clean_sherdog_pfl.csv"

LBS_TO_KG = 0.453592
INCH_TO_CM = 2.54
FOOT_TO_CM = 30.48

# Colunas do perfil que NAO devem entrar no merge: 'fighter_name' e 100%
# redundante com fighter_1/fighter_2 vindos da fase2 (mesmo nome, as vezes com
# o apelido embutido). Manter gerava as colunas duplicadas f1_/f2_fighter_name.
...
def derive_event_status(df):
    """Reconcilia o status preliminar da fase2 com a data real do evento.

    A fase2 sozinha nao consegue distinguir REALIZADO de AGENDADO, porque o
    Sherdog publica o fight card de eventos futuros do mesmo jeito que o de
    eventos passados. Aqui usamos dois sinais: a data do evento estar no futuro
    e o resultado da luta vir como 'yet to come'.

    Precedencia: AGENDADO > ERRO_FETCH > CANCELADO > REALIZADO.
    """
