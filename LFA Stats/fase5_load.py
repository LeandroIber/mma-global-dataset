...
DATASET_SLUG = "lfa-mma-dataset"
DATASET_TITLE = "LFA MMA Dataset Complete"

CSV_FILE = "clean_sherdog_lfa.csv"
UPLOAD_DIR = "kaggle_upload"
METADATA_FILE = "dataset-metadata.json"

DATASET_DESCRIPTION = (
    "Dataset completo da Legacy Fighting Alliance (LFA), raspado do "
