...
DATASET_SLUG = "oktagon-mma-dataset"
DATASET_TITLE = "Oktagon MMA Dataset Complete"
CSV_FILE = "clean_sherdog_oktagon.csv"
UPLOAD_DIR = "kaggle_upload"
METADATA_FILE = "dataset-metadata.json"
DATASET_DESCRIPTION = (
    "Dataset completo do Oktagon MMA, raspado do "
